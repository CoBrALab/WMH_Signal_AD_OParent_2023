...
ADB_subset = read.csv("../../df_lobar.csv")
...
x_vars = seq(2, 31)
colnames(ADB_subset[,x_vars])
x_vars = x_vars[!x_vars %in% c(3,4,7)] # remove age, sex and education from x vars
